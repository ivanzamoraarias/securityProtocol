...
public class firstPartProtocol {
	
	int R;
	String publicKeyFile;
	//String message;
	String saludo;
	public firstPartProtocol()
	{
		
	}
	public firstPartProtocol(String Pubfile, String hello, int r) {
	...
	public String getDecriptData(String privateKeyFilename, String encryptedData)
	{
	...
	{
		String s= saludo+":";
		s+=this.getEncryptData(publicKeyFile, Integer.toString(R));
		return s;
		//return null;
	}
	
	private String getEncryptData (String publicKeyFilename, String mensaje){
